    ...
    public async Task The_document_is_served_without_a_token_and_names_every_endpoint()
    {
        ...
        Assert.Equal(
            [
                ...
                "/api/v1/enrollments", "/api/v1/enrollments/tokens",
                "/api/v1/enrollments/{code}", "/api/v1/enrollments/{code}/approval",
                "/api/v1/enrollments/{code}/refusal",
                "/api/v1/instance",
                ...
                "/api/v1/tokens", "/api/v1/tokens/{id}", "/api/v1/tokens/{id}/purge",
