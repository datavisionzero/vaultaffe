...
namespace Vaultaffe.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260910050020_AgentEnrollment")]
    partial class AgentEnrollment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vaultaffe.Domain.Identities.DeviceAuthorization", b =>
                {
                    ...
                    b.ToTable("device_authorization", null, t =>
                        {
                            t.HasCheckConstraint("ck_device_authorization_produces", "produces between 1 and 2");
                        });
                });

            modelBuilder.Entity("Vaultaffe.Domain.Identities.EnrollmentBinding", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AuthorizationId", "ProjectId", "EnvironmentId")
                        .IsUnique()
                        .HasDatabaseName("ux_enrollment_binding_authorization_project_environment");

                    NpgsqlIndexBuilderExtensions.AreNullsDistinct(b.HasIndex("AuthorizationId", "ProjectId", "EnvironmentId"), false);

                    b.ToTable("enrollment_binding", (string)null);
                });
            ...
            modelBuilder.Entity("Vaultaffe.Domain.Identities.EnrollmentBinding", b =>
                {
                    b.HasOne("Vaultaffe.Domain.Identities.DeviceAuthorization", null)
                        .WithMany("ApprovedBindings")
