 ...
 *
 * Whose instance this is arrives as a prop rather than as an ask of its own:
 * the door already asked, because the same answer decides whether this screen
 * is the right one at all (`Doorway`).
 *
...
export function SignIn({
  ...
  return (
    <Doorstep title="Sign in" meta={organization !== undefined ? `to ${organization}` : undefined}>
